...
test_img1 = cv2.imread("priya-aishh/dataset/test_data/test1.jpg")
test_img2 = cv2.imread("priya-aishh/dataset/test_data/test2.jpg")
test_img3 = cv2.imread("priya-aishh/dataset/test_data/test3.jpg")
test_img4 = cv2.imread("priya-aishh/dataset/test_data/test4.jpg")
